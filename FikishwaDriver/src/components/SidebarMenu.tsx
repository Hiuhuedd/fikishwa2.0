...
const SidebarMenu = ({
    ...
    const MenuItem = ({ icon: Icon, title, onPress, color = '#4A1D24', bgColor = '#FFF7ED' }: any) => (
        ...
        <>
            ...
            <View style={styles.sidebar}>
                ...
                <View style={styles.sidebarContent}>
                    <MenuItem icon={MapPin} title="Dashboard" onPress={onDashboardPress} color="#007AFF" bgColor="#E1F0FF" />
...
const styles = StyleSheet.create({
    ...
    sidebarHeader: { padding: 24, backgroundColor: '#4A1D24', flexDirection: 'row', alignItems: 'center', gap: 16 },
    ...
    sidebarContent: { flex: 1, padding: 16, paddingTop: 24 },
    ...
    sidebarFooter: { padding: 24, borderTopWidth: 1, borderTopColor: '#F2F2F7', flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: Platform.OS === 'ios' ? 20 : 0 },
